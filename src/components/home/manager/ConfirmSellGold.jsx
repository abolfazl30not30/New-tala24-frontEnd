...
export default function ConfirmSellGold() {
    ...
    return (
        <div className="bg-[#141414] mx-8 mt-8 p-4 rounded-lg overflow-scroll">
            <div className="text-white text-lg font-medium">درخواست فروش طلا</div>
                            ...
                            >
                                <Dialog.Panel
                                    ...
                                    <div className="flex flex-col mt-6">
                                        <span className='mb-4'>آیا از تغیر وضعیت فروش طلا مطمئن هستید؟</span>
                                        {
                                            isReject === true
                                                ? (
                                                    <>
