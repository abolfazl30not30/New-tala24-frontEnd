                                    ...
                                    <div>
                                        <div className="text-center mt-2 mb-5 text-gold ">
                                            <h3 className="heading-title-comment font-bold text-xl"> درخواست
                                                خرید {EnglishToPersian((index + 1).toString())}</h3>
                                        </div>
                                        ...
                                        <div className='flex flex-row items-center mb-2'>
                                            <MdArrowBackIosNew className={"text-gold"}/>
                                            <div className="request-item-title text-gold ml-4">وضعیت درخواست :</div>
                                            <div>
                                                <OverlayTrigger
                                        ...
                                        <div className='flex flex-row justify-center mt-10'>
                                            {
                                                data.isAuthorized === "successful" ? <button
                                                    className={"status disabled:bg-amber-200 disabled:text-gray-600 bg-gold text-black px-16 py-2"}
                                                    onClick={() => handleBuyGold(data)}>
                                                    تکمیل خرید
                                                </button> : <button
                                                    className={"status disabled:bg-amber-200 disabled:text-gray-600 bg-gold text-black px-16 py-2 disabled:bg-neutral-500 disabled:text-bgGray disabled:cursor-not-allowed "}
                                                    onClick={() => handleBuyGold(data)} disabled>
                                                    تکمیل خرید
                                                </button>
                                            }
                                        </div>
